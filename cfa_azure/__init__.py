...
if log_status is None or log_status.lower().startswith ("both"):
    handler = [
        logging.StreamHandler(sys.stdout),
        logging.FileHandler(logfile)
    ]
if log_status.lower().startswith("file"):
    handler = [
        logging.FileHandler(logfile)
    ]
    ...
    print(f"Did not recognize {log_status}. Setting to BOTH (file and stdout.)")
    handler = [
        logging.StreamHandler(sys.stdout),
        logging.FileHandler(logfile)
    ]
